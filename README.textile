 ...
 * Exibir o número da linha na lateral esquerda do texto, com o keymap: [Leader] + ln;
 * Exibir a distância da linha atual, em linhas, na lateral esquerda do texto, com o keymap: [Leader] + lr;
