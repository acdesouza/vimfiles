 ...
 * "Melhor guia de consulta rápida":http://walking-without-crutches.heroku.com/image/images/vi-vim-cheat-sheet.png.
...
<pre><code>git clone https://github.com/acdesouza/vimfiles.git .vim
 ...
 * Exibir o número da linha na lateral esquerda do texto, com o keymap: Control + N;
 * Exibir a distância da linha atual, em linhas, na lateral esquerda do texto, com o keymap: Control + N (x2);
 ...
 * Identação automática, isto é, a indentação da próxima linha é a mesma da linha atual;
 ...
 * Configurar a linha de status para exibir: nome do arquivo; coluna atual,linha atual/total de linhas percentual no arquivo%
