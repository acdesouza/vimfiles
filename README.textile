 ...
 * "ale":https://github.com/dense-analysis/ale - Linter para várias linguagens. Estou usando para rodar o rubocop
 * "vim-rvm":https://github.com/tpope/vim-rvm - Usar a configuração do diretório atual para definir a versão do Ruby e gems disponíveis para o vim.
