...
Feito isso, entre no VIM e execute:
<pre><code>
...
Precisa do XCode. O XCode vem com o CD de instalação do Mac.
A versão mais nova é o "XCode4, que dá para comprar e baixar pela App Store":http://itunes.apple.com/br/app/xcode/id422352214?mt=12
 ...
 * Indentação inteligente, isto é, quando for criado um bloco de código, a próxima linha terá sua indentação incrementada;
 * Tabulação de 2 caracteres;
 * Substituir os caracteres de tabulação pelo de espaço;
 * Apagar os espaços sobrando no fim das linhas;
